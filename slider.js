...
document.querySelector("slider__carousel-wrapper").addEventListener("mouseenter", () => {
    clearInterval(currentIntervalId);
    currentIntervalId = null;
});​
document.querySelector(".slider__carousel-wrapper").addEventListener("mouseleave", () => {
